...
- [Smart Contract & Axia Ink!](https://app.element.io/#/room/!tYUCYdSvSYPMjWNDDD:matrix.axia.io?via=matrix.axia.io&via=matrix.org&via=AXIA.org) - 讨论基于 Axia Ink! 开发的 Substrate 智能合约的聊天室
...
- [AXIA 上的团队建设](https://axiaproject.com/) - 社区维护的团队列表建立在 AXIA 和/或 Substrate 上。(请注意，这里可能有些不准确，因为它是非官方的)
