...
> [hasKey](https://AXIA.js.org/docs/substrate/rpc/#haskeypublickey-bytes-keytype-text-bool) to
> check for a specific key or
> [hasSessionKeys](https://AXIA.js.org/docs/substrate/rpc/#hassessionkeyssessionkeys-bytes-bool)
